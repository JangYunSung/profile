...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <body>
     <form name="join" onsubmit="return validate();" method="post" action="join.do">
    ...
    <table border="1" align="center">
        ...
        <tr>
            ...
            <td><input type="text" name="userid" id="uid" size="20" maxlength="12"></input>&nbsp4~12자의 영문 대소문자와 숫자로만 입력</td>
        </tr>
 
        <tr>
            <td align="center"><b>비밀번호:</td>
            <td><input type="password" name="userpw" id="upw" size="21" maxlength="12"></input>&nbsp4~12자의 영문 대소문자와 숫자로만 입력</td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" name="useremail" id="uemail" size="25"></input>&nbsp예) id@domain.com</td>
        </tr>
 
        <tr>
            <td align="center"><b>이름:</td>
            <td><input type="text" name="username" id="uname" size="25"></input></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" name="usernum1" id="unum1" size="10" maxlength="6">-</input><input type="password" name="usernum2" id="unum2" size="10" maxlength="7"></input>
            예) 123456-1234567
            </td>
        </tr>
